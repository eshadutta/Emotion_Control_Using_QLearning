# -*- coding: utf-8 -*-
"""
Created on Sun Jan 12 18:07:49 2020
...
def populateNextStateTableNew(training, no_of_emotions=16):
    ...
    for emotion in emotionIndices.keys():
        ...
        for song_id in song_categorization.keys():
            valence = song_categorization[song_id][0] - 4.5
            arousal = song_categorization[song_id][1] - 4.5
